...
import argparse, sys
from tokenmeter.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="tokenmeter", description="TOKENMETER — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from tokenmeter.mcp_server import serve
        return serve()
    if args.cmd == "scan":
