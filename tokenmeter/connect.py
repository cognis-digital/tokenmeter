"""Native cognis-connect emit for tokenmeter — forward findings to any platform.

Maps tokenmeter's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    tokenmeter ... --format json | tokenmeter-emit --to stix
    tokenmeter-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
